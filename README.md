...
```text
app/frontend/generated/rails/index.js
app/frontend/generated/rails/index.d.ts
```
...
It also writes `index.d.ts` for TypeScript users:
...
If no models define enums, `typed_enums` still writes `index.js` and `index.d.ts` files with the generated header and no exports.
